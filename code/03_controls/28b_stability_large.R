#!/usr/bin/env Rscript
# -----------------------------------------------------------------------------
# R5 of the reviewer roadmap: the same replicate pipeline as
# 28_stability_replicates.R, but with larger cell subsamples (default 1,000
# instead of 800), so that the C2/C4 failures of the 800-cell replicates can be
# separated from a genuine instability of the primary networks. Output goes to
# work/stability_large/ and is aggregated by 29b_stability_large_analysis.R.
# -----------------------------------------------------------------------------
# =============================================================================
