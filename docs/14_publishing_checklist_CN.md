...
| Zenodo DOI | Concept **`10.5281/zenodo.22752977`**；最新版本 **`10.5281/zenodo.22833250`**（v1.2.1，2026-09-18 发布，投稿定稿版）／v1.2.0 `10.5281/zenodo.22821165`／`10.5281/zenodo.22814877`（v1.1.0）／`10.5281/zenodo.22752978`（v1.0.0） | ✅ Software、MIT、ORCID 已关联，自动关联到对应 GitHub tag |
...
1. `CITATION.cff`：`doi: "10.5281/zenodo.22833250"`（v1.2.1）与 `version: "1.2.1"`，并保留 concept DOI 与前版本 DOI 注释；
