...
# Writes : results/tables/Table_S15_stability_large_replicates.csv
#          results/tables/Table_S16_stability_large_summary.csv
#          (aggregates work/stability_large/, written by 28b_stability_large.R)
#
...
utils::write.csv(tab, "results/tables/Table_S15_stability_large_replicates.csv", row.names = FALSE)
...
summ <- data.frame(
  ...
  pass = c(all(tab$containment_excl_deg0 >= 99),
           ...
           NA, NA))
utils::write.csv(summ, "results/tables/Table_S16_stability_large_summary.csv", row.names = FALSE)
...
cat("\n已写入 results/tables/Table_S15_stability_large_replicates.csv 与 Table_S16_stability_large_summary.csv\n")
