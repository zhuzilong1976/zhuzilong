...
Qualitative statements about the behaviour of the pipeline therefore generalise across cell samples; statements about effect sizes and rankings do not. The two magnitude-based checkpoints are, however, strongly sample-size dependent, as the larger replicates show.
